...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/polished-breeze-4c94
```

A live public deployment of this template is available at [https://polished-breeze-4c94.templates.workers.dev](https://polished-breeze-4c94.templates.workers.dev)
